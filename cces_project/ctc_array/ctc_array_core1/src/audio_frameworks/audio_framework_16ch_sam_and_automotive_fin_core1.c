...
int section("seg_l1_block1") sport4_dma_rx_0_buffer[AUDIO_CHANNELS * AUDIO_BLOCK_SIZE];
int section("seg_l1_block1") sport4_dma_rx_1_buffer[AUDIO_CHANNELS * AUDIO_BLOCK_SIZE];
int section("seg_l1_block1") sport4_dma_tx_0_buffer[AUDIO_CHANNELS * AUDIO_BLOCK_SIZE];
int section("seg_l1_block1") sport4_dma_tx_1_buffer[AUDIO_CHANNELS * AUDIO_BLOCK_SIZE];
